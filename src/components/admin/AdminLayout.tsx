...
import { CircleHelp, FileText, Globe2, LayoutDashboard, Library, LogOut, Menu, Newspaper, PenLine, Trophy } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/admin/fill-blanks', label: 'Điền khuyết', icon: PenLine, exact: false },
